...
export default function Dashboard() {
  ...
  return (
    <div style={{display:'flex',flexDirection:'column',minHeight:'100vh',background:'#fff'}}>
      ...
      <div style={{flex:1,padding:'24px 28px',display:'flex',flexDirection:'column',gap:20,background:'#fff'}}>
        ...
        <div style={{display:'grid',gridTemplateColumns:'repeat(4,1fr)',gap:14}}>
          {[
            ...
            <div key={k.label} style={{background:'#fff',borderRadius:10,border:'0.5px solid #E4E4E7',padding:'20px'}}>
              ...
              {loading ? <Sk w={60} h={30}/> :
                <div style={{fontSize:30,fontWeight:600,color:'#18181B',marginBottom:4}}>
        ...
        <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:14}}>
            ...
            {loading ? <Sk h={100}/> : (kpis?.porTipo||[]).map((t:any)=>(
              <div key={t.label} style={{marginBottom:16}}>
                ...
                <div style={{height:5,background:'#F4F4F5',borderRadius:3}}>
                  <div style={{height:5,borderRadius:3,width:`${t.pct}%`,
                    background:t.label==='Preventivo'?'#22C55E':t.label==='Correctivo'?'#EF4444':'#F59E0B'}}/>
                </div>
              </div>
            ))}
          </div>
          ...
          <div style={{background:'#fff',borderRadius:10,border:'0.5px solid #E4E4E7',padding:'20px'}}>
            ...
            {loading ? <Sk h={100}/> : (kpis?.porServicio||[]).map((s:any)=>{
        ...
        {/* Quick actions */}
        <div>
          <div style={{fontSize:12,fontWeight:500,color:'#A1A1AA',marginBottom:10,textTransform:'uppercase',letterSpacing:'0.05em'}}>Acceso rápido</div>
          <div style={{display:'grid',gridTemplateColumns:'repeat(5,1fr)',gap:10}}>
            {[
              ...
              <Link key={a.href} href={a.href} style={{
                ...
                background:'#fff',borderRadius:10,border:'0.5px solid #E4E4E7',
                padding:'14px 16px',textDecoration:'none',color:'#3F3F46',
